...
export const RouterProvider: React.FC = () => {
    ...
    const [team, setTeam] = useState(localStorage.getItem("r6r.team") as Team ?? "attackers")
    const [currentPage, setCurrentPage] = useState<Page>(localStorage.getItem("r6r.page") as Page ?? "/")
